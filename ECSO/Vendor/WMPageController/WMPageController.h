...
@interface WMPageController : STBaseViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
...
@property (nonatomic, nullable, copy) NSString *titleSelecteFontName;
...
/** 顶部导航栏 */
@property (nonatomic, nullable, strong) WMMenuView *menuView;
