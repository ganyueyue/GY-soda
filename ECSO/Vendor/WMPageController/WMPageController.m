...
- (void)wm_addMenuView {
    ...
    if (self.titleSelecteFontName){
        menuView.selectfontName = self.titleSelecteFontName;
    }
...
- (void)wm_adjustMenuViewFrame {
    ...
    if (self.showOnNavigationBar && self.navigationController.navigationBar) {
        ...
        _menuViewFrame.origin.x = 0;
        self.menuView.frame = _menuViewFrame;
        self.menuView.intrinsicContentSize = _menuViewFrame.size;
...
- (CGFloat)wm_calculateItemWithAtIndex:(NSInteger)index {
    NSString *title = [self titleAtIndex:index];
    NSString *calucaleFontName = self.titleSelecteFontName ? self.titleSelecteFontName :self.titleFontName;

    UIFont *titleFont = calucaleFontName ? [UIFont fontWithName:calucaleFontName size:self.titleSizeSelected] : [UIFont systemFontOfSize:self.titleSizeSelected];
